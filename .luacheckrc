...
read_globals = {
    ...
    "AddonCompartmentFrame", "GetRestState", "GetXPExhaustion", "CreateFont", "REPUTATION", "BossTargetFrameContainer", "SHOW_MAP", "ABANDON_QUEST_ABBREV", "SHARE_QUEST_ABBREV", "TRACK_QUEST_ABBREV", "EQUIPMENT_MANAGER", "C_CVar", "CompactRaidFrameManager", "GetPaperDollSideBarFrame", "PAPERDOLL_SIDEBARS", "PaperDollFrame_UpdateSidebarTabs", "ExpansionLandingPageMinimapButton", "FocusFrame", "GameTimeFrame", "IsResting", "MiniMapMailIcon", "Minimap", "MinimapBackdrop", "MinimapCluster", "MinimapCompassTexture", "MinimapCompassTextureUnderlay", "MinimapZoneText", "PartyFrame", "PetAttackModeTexture", "PetCastingBarFrame", "PetFrame", "PetFrameFlash", "PetFrameHealthBar", "PetFrameHealthBarMask", "PetFrameHealthBarText", "PetFrameHealthBarTextLeft", "PetFrameHealthBarTextRight", "PetFrameManaBar", "PetFrameManaBarMask", "PetFrameManaBarText", "PetFrameManaBarTextLeft", "PetFrameManaBarTextRight", "PetFrameTexture", "PetHitIndicator", "PetName", "PetPortrait", "PlayerCastingBarFrame", "PlayerFrame", "PlayerLevelText", "PlayerName", "PowerBarColor", "QueueStatusButton", "TargetFrame", "TimeManagerClockButton", "TimeManagerClockTicker", "UnitAffectingCombat", "UnitCastingInfo", "UnitChannelInfo", "UnitClassification", "UnitExists", "SetPortraitTexture", "SEARCH", "BANK_BAG_PURCHASE", "ITEMSLOTTEXT", "UnitHealth", "UnitHealthMax", "UnitPower", "UnitPowerMax", "UnitPowerType", "issecretvalue",
}
